...
trait DefSyntax {
  implicit class ParentDefIdExtension[A, ADb](val parentDef: ParentDef[cats.Id, A, ADb]) {
    ...
    def forEither[E]: ParentDef.AuxAll[Either[E, *], A, ADb, parentDef.Child, parentDef.ChildVecs, parentDef.Id] = {
...
object DefSyntax {
  private[syntax] implicit def idToEitherFunctionK[E]: FunctionK[cats.Id, Either[E, *]] = new FunctionK[cats.Id, Either[E, *]] {
